...
>  🧵 Category tokens are simpler to use. Learn how to use them in your work. [How to style using design tokens](https://www.notion.so/How-to-style-using-design-tokens-fcc35bf74ce14083962704be5b3939cd?pvs=21)
