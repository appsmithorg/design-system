...
- Category tokens available for input controls:
    ...
    | State | Surface | Presentation attribute | Token name | token value |
    | --- | --- | --- | --- | --- |
