...
- When only one of multiple options can be selected — use a [radio group](https://www.design-system.appsmith.com/?path=/docs/design-system-radio--documentation).
- You want to group multiple options together into a single basic choice — use a [radio group](https://www.design-system.appsmith.com/?path=/docs/design-system-radio--documentation).
- For single on/off settings with an instant response — use a [switch](https://www.design-system.appsmith.com/?path=/docs/design-system-switch--documentation).
- Limited space: When there is limited space available for options or when the list of options is lengthy — use a [Select](https://www.design-system.appsmith.com/?path=/docs/design-system-select--documentation). You can even configure the select to allow picking multiple options.
