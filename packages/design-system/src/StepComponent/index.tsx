...
const StepWrapper = styled.div`
  ...
  background-color: var(
    --ads-property-pane-default-zoom-button-background-color
  );
  && svg {
    path {
      fill: var(--ads-property-pane-default-radio-group-button-text-color);
    }
  }

  &:focus {
    border: 1px solid var(--ads-input-focus-border-color);
  }
`;
...
const InputWrapper = styled.div`
  ...
  color: var(--ads-property-pane-default-radio-group-button-text-color);
  // TODO: Why does the background color have the button text color?
  background-color: var(--ads-property-pane-default-button-text-color);
`;
