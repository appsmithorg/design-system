...
**Size**
- *Small* Compact design for limited space	
- *Medium* Balanced between space and usability	
- *Large* Prominent for easy interaction
...
**Icons**
- *Small* Icons	Simple, easily recognizable icons	
- *Medium* Clear icons that maintain clarity when scaled down	
- *Large* Detailed icons for clear representation
