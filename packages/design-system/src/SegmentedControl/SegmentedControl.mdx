...
Avoid using more than five control as provided in the component. Instead, consider using a [select](https://www.design-system.appsmith.com/?path=/docs/design-system-select--documentation).
